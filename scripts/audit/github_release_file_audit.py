...
REQUIRED_PUBLIC_FILES = (
    ...
    "docs/51_multi_endpoint_benefit_risk_portfolio.md",
    "docs/52_same_trial_multi_endpoint_stress.md",
    ...
    "agentic_drug_discovery/clinical_benefit_risk_portfolio.py",
    "agentic_drug_discovery/clinical_benefit_risk_portfolio_stress.py",
    ...
    "tests/test_clinical_benefit_risk_portfolio.py",
    "tests/test_clinical_benefit_risk_portfolio_stress.py",
