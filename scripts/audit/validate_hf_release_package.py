...
REQUIRED_HF_INCLUDES = {
    ...
    "docs/28_clinical_evidence_closed_loop.md",
    ...
    "docs/58_structural_disagreement_decomposition.md",
    "docs/ra_olokizumab_mtx_ir_structure_spec.json",
    "docs/ra_olokizumab_mtx_ir_structure_report.json",
    "docs/uc_ozanimod_structure_spec.json",
    "docs/uc_ozanimod_structure_report.json",
    ...
    "tests/test_clinicaltrials_gov_harmonization_structure.py",
    "tests/test_clinicaltrials_gov_structural_presence.py",
    ...
    "scripts/audit/build_pattern_mixture_influence_study.py",
    "scripts/audit/build_informative_cluster_size_study.py",
    "scripts/audit/build_cluster_superpopulation_study.py",
    ...
    "scripts/audit/validate_translational_handoff.py",
...
REQUIRED_HF_EXCLUSIONS = {
    ...
    "real clinical prediction submissions, outcome manifests, unit-level endpoint/safety labels, source assessments, curator materials, and per-unit evaluation results",
    "real clinical outcome dependence manifests, unit-to-cluster assignments, cluster-level results, and unit-level uncertainty contributions",
    "real clinical outcome design scenarios, pilot parameter elicitation, replicate-level simulation records, and non-public gate-selection deliberations",
    "real clinical outcome stress scenarios, missingness-model elicitation, hidden-dependence working records, replicate-level simulation records, and correction-selection deliberations",
    "real clinical outcome sensitivity protocols, log-IMOR elicitation, prediction-stratum working records, latent outcomes, and correction-selection deliberations",
    "real cluster-superpopulation sampling frames, cluster covariates, transport models, post-hoc design-selection deliberations, and replicate-, cluster-, or unit-level results",
    "real collaborator or Biohub program data, biomodel outputs, cell-state or perturbation payloads, reviewer assignments, manual baseline worksheets, adjudication records, pilot timings, and program-level pilot results",
    "real upstream cell-state or perturbation payloads, source bytes, donor or cell records, scientific-owner mappings, reviewer identities, and non-public handoff fixtures",
    "real clinical closed-loop policies, execution batches, provider requests or outcomes, receipts, reviewer refresh records, before/after tensors, and transition packages",
...
REQUIRED_PACKAGE_FILES = {
    ...
    "docs/uc_ozanimod_structure_spec.json",
    "docs/uc_ozanimod_structure_report.json",
    "docs/59_presence_preserving_structural_arrays.md",
    "docs/ra_olokizumab_mtx_ir_presence_spec.json",
    "docs/ra_olokizumab_mtx_ir_presence_report.json",
    "docs/uc_ozanimod_presence_spec.json",
    "docs/uc_ozanimod_presence_report.json",
    "docs/50_adds_frontier_research_protocol.md",
    "docs/adds_frontier_research_protocol.json",
    "docs/adds_frontier_board_protocol.json",
    "docs/retrospective_policy_evaluation_snapshot.json",
    ...
    "agentic_drug_discovery/clinicaltrials_gov_harmonization_structure.py",
    "agentic_drug_discovery/clinicaltrials_gov_structural_presence.py",
    ...
    "agentic_drug_discovery/clinical_effects.py",
    "agentic_drug_discovery/clinical_workflow.py",
    "agentic_drug_discovery/clinical_decision_cli.py",
    ...
    "rl_env/specs/clinicaltrials_gov_harmonization_structure_spec.schema.json",
    "rl_env/specs/clinicaltrials_gov_harmonization_structure_spec.example.json",
    "rl_env/specs/clinicaltrials_gov_harmonization_structure_report.schema.json",
    "rl_env/specs/clinicaltrials_gov_structural_presence_spec.schema.json",
    "rl_env/specs/clinicaltrials_gov_structural_presence_spec.example.json",
    "rl_env/specs/clinicaltrials_gov_structural_presence_packet.schema.json",
    "rl_env/specs/clinicaltrials_gov_harmonization_presence_spec.schema.json",
    "rl_env/specs/clinicaltrials_gov_harmonization_presence_spec.example.json",
    "rl_env/specs/clinicaltrials_gov_harmonization_presence_report.schema.json",
    ...
    "rl_env/specs/clinical_outcome_evaluation_protocol.example.json",
    "rl_env/specs/clinical_prediction_submission.schema.json",
    "rl_env/specs/clinical_prediction_submission.example.json",
    "rl_env/specs/clinical_prediction_submission.relaxed.example.json",
    "rl_env/specs/clinical_outcome_manifest.schema.json",
    "rl_env/specs/clinical_outcome_manifest.example.json",
    "rl_env/specs/clinical_outcome_evaluation_report.schema.json",
    "rl_env/specs/clinical_outcome_evaluation_report.example.json",
    ...
    "rl_env/specs/clinical_outcome_dependence_manifest.example.json",
    "rl_env/specs/clinical_outcome_uncertainty_protocol.schema.json",
    "rl_env/specs/clinical_outcome_uncertainty_protocol.example.json",
    "rl_env/specs/clinical_outcome_uncertainty_report.schema.json",
    "rl_env/specs/clinical_outcome_uncertainty_report.example.json",
    ...
    "rl_env/specs/clinical_outcome_design_simulation_protocol.example.json",
    "rl_env/specs/clinical_outcome_design_simulation_report.schema.json",
    "rl_env/specs/clinical_outcome_design_simulation_report.example.json",
    ...
    "rl_env/specs/translational_handoff.uc.synthetic.example.json",
    "rl_env/specs/clinical_endpoint_mapping.uc.synthetic.example.json",
    "rl_env/specs/clinical_benefit_risk_synthesis.uc.synthetic.example.json",
    ...
    "rl_env/specs/heldout_evaluation_protocol.example.json",
    "rl_env/specs/heldout_curation_manifest.schema.json",
    "rl_env/specs/stage_stratified_evaluation_report.schema.json",
    "rl_env/specs/stage_stratified_evaluation_report.example.json",
    "tests/test_agent_loop.py",
    "tests/test_environment.py",
    "tests/test_execution.py",
    "tests/test_matched_evaluation.py",
