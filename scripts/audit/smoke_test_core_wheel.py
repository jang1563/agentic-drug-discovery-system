...
""",
                ...
                [
                    *python_command,
                    ...
                    (
                        ...
                        "clinicaltrials_gov_estimand_evidence_acquisition_packet_from_json, "
                        "clinicaltrials_gov_estimand_evidence_acquisition_spec_from_json, "
                        ...
                        "); "
                        "assert CLINICAL_BENEFIT_RISK_PORTFOLIO_REPORT_SCHEMA_VERSION == "
                        "'adds.clinical-benefit-risk-portfolio-report.v1'; "
                        "assert CLINICAL_BENEFIT_RISK_PORTFOLIO_SPEC_SCHEMA_VERSION == "
                        "'adds.clinical-benefit-risk-portfolio-spec.v1'; "
                        "assert CLINICAL_BENEFIT_RISK_PORTFOLIO_STRESS_REPORT_SCHEMA_VERSION == "
                        "'adds.clinical-benefit-risk-portfolio-stress-report.v1'; "
                        "assert CLINICAL_ENDPOINT_REVIEW_CANDIDATE_PACKET_SCHEMA_VERSION == "
                        ...
                        "assert CLINICALTRIALS_GOV_HARMONIZATION_DIAGNOSTIC_REPORT_SCHEMA_VERSION == "
                        "'adds.clinicaltrials-gov-harmonization-diagnostic-report.v1'; "
                        "assert CLINICALTRIALS_GOV_HARMONIZATION_DIAGNOSTIC_SPEC_SCHEMA_VERSION == "
                        "'adds.clinicaltrials-gov-harmonization-diagnostic-spec.v1'; "
                        "assert CLINICALTRIALS_GOV_HARMONIZATION_STRUCTURE_REPORT_SCHEMA_VERSION == "
                        ...
                        "assert CLINICALTRIALS_GOV_ENDPOINT_ESTIMAND_PREFLIGHT_PACKET_SCHEMA_VERSION == "
                        "'adds.clinicaltrials-gov-endpoint-estimand-preflight-packet.v1'; "
                        "assert CLINICALTRIALS_GOV_ENDPOINT_ESTIMAND_PREFLIGHT_SPEC_SCHEMA_VERSION == "
                        "'adds.clinicaltrials-gov-endpoint-estimand-preflight-spec.v1'; "
                        "assert CLINICALTRIALS_GOV_ESTIMAND_EVIDENCE_ACQUISITION_PACKET_SCHEMA_VERSION == "
                        "'adds.clinicaltrials-gov-estimand-evidence-acquisition-packet.v1'; "
                        "assert CLINICALTRIALS_GOV_ESTIMAND_EVIDENCE_ACQUISITION_SPEC_SCHEMA_VERSION == "
    ...
    print(
        ...
        "multi-trial portfolio extraction plus endpoint/estimand preflight and evidence-acquisition public APIs, "
