...
""",
    ...
    if public_api.stdout.strip() != "public-api-ok":
        return fail(
            "sealed evaluation, clinical cohort/outcome/uncertainty, and closed-loop APIs were not importable "
            "from the wheel"
        )
    ...
    print(
        ...
        "plus sealed evaluation, clinical cohort/outcome/uncertainty, and closed-loop API smoke tests "
