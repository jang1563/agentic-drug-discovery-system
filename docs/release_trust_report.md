...
This report summarizes what the public GitHub repository and Hugging Face Dataset mirror are intended to prove, what they do not prove, and which files machines should inspect first. The 0.3.0.dev0 execution-core update is the current public development release after exact-package approval; 0.3.0.dev1 is an unapproved candidate, and 0.2.0 remains the latest tagged stable release.
...
| The release decision is machine-readable. | `release_decision_packet.json` | The 0.3.0.dev0 baseline records approval, GitHub publication, and Hub upload. The 0.3.0.dev1 candidate is explicitly unmerged, not uploaded, and pending a new approval record. |
