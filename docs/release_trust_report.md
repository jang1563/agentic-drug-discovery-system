...
| The release decision is machine-readable. | `release_decision_packet.json` | The 0.3.0.dev2 release records explicit approval, GitHub publication, the initial Hub upload, exact source identities, and file count; every future update requires a new approval record. |
