...
""",
    ...
    if public_api.stdout.strip() != "public-api-ok":
        return fail(
            ...
            "pattern-mixture-uncertainty/influence/informative-cluster-size, and closed-loop "
    ...
    print(
        ...
        "pattern-mixture-uncertainty/influence/informative-cluster-size, and closed-loop API "
        "smoke tests "
