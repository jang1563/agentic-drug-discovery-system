...
This report summarizes what the public GitHub repository and Hugging Face Dataset mirror are intended to prove, what they do not prove, and which files machines should inspect first. The 0.3.0.dev1 evidence-governed execution, held-out evaluation, clinical planning, and closed-loop update is the current public development release after exact-package approval; 0.2.0 remains the latest tagged stable release.
...
| The release decision is machine-readable. | `release_decision_packet.json` | The 0.3.0.dev1 release records explicit approval, GitHub publication, the initial Hub upload, exact source identities, and file count; every future update requires a new approval record. |
...
The public 0.3.0.dev1 Hub package is a deliberate subset of GitHub. Live adapters, legacy chains,
